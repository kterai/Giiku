...
import jp.co.apsa.unryu.application.dto.TravelRequestDto;
...
public class TravelRequestController {
    ...
    @ResponseBody
    public jp.co.apsa.unryu.application.dto.TravelRequestDto action(@PathVariable Long id, @RequestParam String action) {
