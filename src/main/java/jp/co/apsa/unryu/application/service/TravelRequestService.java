...
import jp.co.apsa.unryu.domain.repository.TravelRequestRepository;
...
public class TravelRequestService {
     ...
     */
    @Transactional(readOnly = true)
    public java.util.List<jp.co.apsa.unryu.application.dto.TravelRequestDto> findAllDtos() {
     ...
     */
    @Transactional(readOnly = true)
    public jp.co.apsa.unryu.application.dto.TravelRequestDto findDtoById(Long id) {
     ...
     */
    @Transactional(readOnly = true)
    public jp.co.apsa.unryu.application.dto.TravelRequestDto findDtoByApplicationId(Long applicationId) {
     ...
     */
    @Transactional(readOnly = true)
    public java.util.List<jp.co.apsa.unryu.application.dto.TravelRequestDto> findDtosByStatuses(java.util.List<String> statuses) {
        return travelRequestRepository.findByStatusIn(statuses).stream()
                .map(this::toDto)
                .toList();
    }

    private jp.co.apsa.unryu.application.dto.TravelRequestDto toDto(TravelRequestDetails details) {
        return jp.co.apsa.unryu.application.dto.TravelRequestDto.builder()
                .id(details.getId())
