...
import jp.co.apsa.unryu.application.command.CreateApplicationCommand;
...
import jp.co.apsa.unryu.domain.repository.ApplicationApprovalRepository;
import jp.co.apsa.unryu.domain.repository.ApplicationRepository;
import jp.co.apsa.unryu.domain.repository.ApplicationApprovalRouteRepository;
import jp.co.apsa.unryu.domain.repository.DepartmentRepository;
import jp.co.apsa.unryu.domain.repository.UserRepository;
import jp.co.apsa.unryu.domain.valueobject.ApplicationStatus;
import jp.co.apsa.unryu.domain.valueobject.ApprovalStatus;
import jp.co.apsa.unryu.domain.valueobject.ApprovalAction;
import jp.co.apsa.unryu.domain.port.AuditPort;
...
public class ApplicationService {
    ...
    public java.util.List<jp.co.apsa.unryu.application.dto.ApplicationDto> findDtosByStatuses(java.util.List<String> statuses) {
     ...
     */
    @Transactional(readOnly = true)
    public java.util.List<jp.co.apsa.unryu.application.dto.ApplicationDto> findDtosByApplicantId(Long applicantId) {
     ...
     */
    @Transactional(readOnly = true)
    public jp.co.apsa.unryu.application.dto.ApplicationDto findDtoById(Long id) {
     ...
     */
    @Transactional(readOnly = true)
    public java.util.List<jp.co.apsa.unryu.application.dto.ApplicationApprovalDto> findApprovalDtosByApplicationId(Long applicationId) {
     ...
     * 申請を取下げます。
     *
     * <p>申請が未承認かつ申請者本人の場合のみ、状態を {@link jp.co.apsa.unryu.domain.valueobject.ApplicationStatus#WITHDRAWN}
     * に更新します。</p>
     *
     * @param applicationId 申請ID
     * @param applicantId   申請者ID
    ...
    private jp.co.apsa.unryu.application.dto.ApplicationDto toDto(Application app) {
        ...
        return jp.co.apsa.unryu.application.dto.ApplicationDto.builder()
                .id(app.getId())
                .typeName(typeName)
                .title(app.getTitle())
    ...
    private jp.co.apsa.unryu.application.dto.ApplicationApprovalDto toApprovalDto(jp.co.apsa.unryu.domain.entity.ApplicationApproval approval) {
        String approverName = null;
        if (approval.getApprover() != null) {
            approverName = approval.getApprover().getName();
        }
        return jp.co.apsa.unryu.application.dto.ApplicationApprovalDto.builder()
