...
import jp.co.apsa.giiku.domain.repository.ExpenseRequestRepository;
...
public class ExpenseRequestService {
     ...
     */
    @Transactional(readOnly = true)
    public java.util.List<jp.co.apsa.giiku.application.dto.ExpenseRequestDto> findAllDtos() {
     ...
     */
    @Transactional(readOnly = true)
    public jp.co.apsa.giiku.application.dto.ExpenseRequestDto findDtoById(Long id) {
     ...
     */
    @Transactional(readOnly = true)
    public jp.co.apsa.giiku.application.dto.ExpenseRequestDto findDtoByApplicationId(Long applicationId) {
     ...
     */
    @Transactional(readOnly = true)
    public java.util.List<jp.co.apsa.giiku.application.dto.ExpenseRequestDto> findDtosByStatuses(java.util.List<String> statuses) {
        return expenseRequestRepository.findByStatusIn(statuses).stream()
                .map(this::toDto)
                .toList();
    }

    private jp.co.apsa.giiku.application.dto.ExpenseRequestDto toDto(ExpenseRequestDetails details) {
        return jp.co.apsa.giiku.application.dto.ExpenseRequestDto.builder()
                .id(details.getId())
