 ...
 * @since 2025
 * 
 * @see jp.co.apsa.giiku.application.service.ApplicationService
 * @see jp.co.apsa.giiku.domain.entity.Application
 * @see jp.co.apsa.giiku.domain.valueobject.ApplicationStatus
 */
@Data
@Builder
