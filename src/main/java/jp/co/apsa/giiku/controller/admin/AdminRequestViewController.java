...
public class AdminRequestViewController {
    ...
    public String list(Model model) {
        List<ApplicationDto> requests = applicationService.findDtosByStatuses(
                java.util.List.of(
                        jp.co.apsa.giiku.domain.valueobject.ApplicationStatus.PENDING,
                        jp.co.apsa.giiku.domain.valueobject.ApplicationStatus.IN_REVIEW,
                        jp.co.apsa.giiku.domain.valueobject.ApplicationStatus.APPROVED));
