...
ALTER TABLE public.application_approval_routes OWNER TO postgres;
...
ALTER SEQUENCE public.application_approval_routes_id_seq OWNER TO postgres;
...
ALTER TABLE public.application_approvals OWNER TO postgres;
...
ALTER SEQUENCE public.application_approvals_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.application_attachments_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.approval_routes_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.approval_steps_id_seq OWNER TO postgres;
...
ALTER TABLE public.department_responsible_users OWNER TO postgres;
...
ALTER SEQUENCE public.department_responsible_users_id_seq OWNER TO postgres;
...
ALTER TABLE public.travel_request_details OWNER TO postgres;
...
ALTER SEQUENCE public.travel_request_details_id_seq OWNER TO postgres;
...
ALTER TABLE public.expense_request_details OWNER TO postgres;
...
ALTER SEQUENCE public.expense_request_details_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.travel_requests_id_seq OWNER TO postgres;
...
--
-- Name: COLUMN users.approver; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.users.approver IS '承認者フラグ';
...
ALTER TABLE ONLY public.travel_request_details
    ADD CONSTRAINT travel_request_details_pkey PRIMARY KEY (application_id);
...
ALTER TABLE ONLY public.expense_request_details
    ADD CONSTRAINT expense_request_details_pkey PRIMARY KEY (application_id);
